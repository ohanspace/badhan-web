     ...
     <div class="panel panel-info" >
        <div class="panel-heading">
            ...
            <div style="float:right; font-size: 85%; position: relative; top:-10px">
                <a href="<?php echo site_url('member/complete_registration/resend')?>">resend code?</a>
            </div>
        </div>     
        ...
        <div style="" class="panel-body" >
            ...
            <!--alert-->
            <div id="complete_registration_alert" class="alert alert-danger col-sm-12">
	            <?php if($this->session->flashdata('sms_failed')): ?>
	            	<?php echo $this->session->flashdata('sms_failed'); ?>
	            	<p><a href="<?php echo site_url('member/complete_registration/resend')?>">resend code?</a></p>
	            <?php elseif($this->session->userdata('sms_id')) :?>
	            	<p>Enter the KEY that has been sent to your phone  <?php echo  $this->session->userdata('temp_user_telephone')?></p>
