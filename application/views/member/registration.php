             ...
             <form id="signupform" class="form-horizontal" role="form" method="post" >
                    ...
                    <div class="form-group">
                       ...
                       <div class="col-md-8">
                           <select class="form-control selectpicker" name="district_id" id="district_id">
                               <option disabled selected value=NULL>Select your current district</option>
									<?php foreach ($districts as $district):?>
                                   <option value="<?php echo $district->district_id?>" <?php echo set_select('district',$district->district_id);?>><?php echo $district->name?></option>
                                   <?php endforeach;?>
                    ...
                    <div class="form-group">                                                              
                        <div class="col-md-offset-4 col-md-8">
                            <button  type="submit" class="btn btn-info"><span class="glyphicon glyphicon-ok"></span> &nbsp Sign Up</button>
