...
<?php if(count($pages)): foreach($pages as $page): ?>	
		<tr>
			<td><?php echo anchor('admin/page/edit/' . $page->page_id, $page->title); ?></td>
			<td><?php echo $page->parent_slug; ?></td>
			<td><?php echo btn_edit('admin/page/edit/' . $page->page_id); ?></td>
			<td><?php echo btn_delete('admin/page/delete/' . $page->page_id); ?></td>
		</tr>
<?php endforeach; ?>
<?php else: ?>
		<tr>
