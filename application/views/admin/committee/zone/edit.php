...
<table class='table'>
  ...
  <tr>
    <td>Designation</td>
    <td><?php echo form_dropdown('designation_id',$zone_committee_designations,$committee_member->designation_id)?></td>
  </tr>
  <tr>
  	<td>Name</td>
  ...
  <tr>
  	<td>Unit</td>
  	<td><?php echo form_dropdown('unit_id',$units_option,$committee_member->unit_id)?></td>
  </tr>
  <tr>
  	<td>Session</td>
