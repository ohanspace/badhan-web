<div class="panel panel-info">
    <!--panel heading-->
         <div class="panel-heading">
                <div class="panel-title"><?php echo empty($unit->unit_id) ? 'Add a new unit' : 'Edit unit: ' .'<strong>'. $unit->name.'</strong>'; ?></div>
                <div style="float:right; font-size: 85%; position: relative; top:-10px"><a id="signinlink" href="<?php echo site_url('admin/unit');?>">All Units</a></div>
         </div>
    <!--panel body-->
         <div class="panel-body" >                        
             <form id="unit-edit-form" class="form-horizontal" role="form" method="post" action="<?php echo current_url(); ?>" >
                <!--validation error-->
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input type="text" class="form-control" id="name" name="name" value="<?php echo $unit->name;?>" placeholder="Unit Name" required maxlength="100">
                    </div>
                </div>
                <!--Name In Bangla-->
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input type="text" class="form-control" id="name_in_bangla" name="name_in_bangla" value="<?php echo $unit->name_in_bangla;?>" placeholder="Name In Bangla" required maxlength="100">
                    </div>
                </div>
                <!--Short Name-->
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input type="text" class="form-control" id="short_name" name="short_name" value="<?php echo $unit->short_name;?>" placeholder="Short Name" required maxlength="100">
                    </div>
                </div>
                <!--Select Institution-->
                <div class="form-group">
                                ...
                                <?php if(count($institutions['UNIVERSITIES'])) : ?>
                                        <optgroup label="Universities">
                                            <?php foreach ($institutions['UNIVERSITIES'] as $university): ?>
                                                <option value="<?php echo $university->institution_id ?>" <?php echo set_select('institution_id',$university->institution_id,$university->institution_id==$unit->institution_id?TRUE:FALSE);?> ><?php echo $university->name; ?></option>
                                            <?php endforeach; ?>
                                        </optgroup>
                                <?php endif;?>
                                <?php if(count($institutions['COLLEGES'])) : ?>
                                    <optgroup label="Colleges">
                                        <?php foreach ($institutions['COLLEGES'] as $college): ?>
                                            <option value="<?php echo $college->institution_id ?>" <?php echo set_select('institution_id',$college->institution_id,$college->institution_id==$unit->institution_id?TRUE:FALSE);?> ><?php echo $college->name; ?></option>
                                        <?php endforeach; ?>
                                    </optgroup>
                                <?php endif;?>
                               <?php if(count($institutions['UNIVERSITYCOLLEGES'])) : ?>
                                    <optgroup label="University Colleges">
                                        <?php foreach ($institutions['UNIVERSITYCOLLEGES'] as $universitycollege): ?>
                                            <option value="<?php echo $universitycollege->institution_id ?>" <?php echo set_select('institution_id',$universitycollege->institution_id,$universitycollege->institution_id==$unit->institution_id?TRUE:FALSE);?> ><?php echo $universitycollege->name; ?></option>
                                        <?php endforeach; ?>
                                    </optgroup>
                                <?php endif;?>
                           <?php endif;?>                                                                                                                        
                ...
                <div class="form-group">
                   ...
                   <div class="col-md-8">
                       <select class="form-control selectpicker" name="zone_id" id="zone_id">
                           <option value="NULL" >Individual Unit</option>
                           <?php if(isset($zones)): foreach ($zones as $zone): ?>
                           <option value="<?php echo $zone->zone_id ?>" <?php echo set_select('zone_id',$zone->zone_id,$zone->zone_id == $unit->zone_id?TRUE:FALSE);?> ><?php echo $zone->name; ?></option>
               ...
               <!--Facebook group-->
                ...
                <div class="form-group">                                                              
                    <div class="col-md-offset-4 col-md-8">
                        ...
                        <a id="btn-cancel" href="<?php echo site_url('admin/unit');?>" class="btn btn-info"><i class="glyphicon glyphicon-remove"></i>&nbsp Cancel</a>
                    </div>
                </div>                  
              </form>
          </div>
